...
const Form = ({product, formNewProduct}) => {
    ...
    const handleSubmit = async (e) =>{
        ...
        const requestPost = {url: "http://129.151.109.230:8080/api/product/new", method: "POST"};
        const requestPut = {url: "http://129.151.109.230:8080/api/product/update", method: "PUT"};
